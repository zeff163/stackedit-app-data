...
+ **API（Application Program Interface）**
  ...
  >  如果对应到电脑中，WPS软件和操作系统之间也是通过API实现文件访问，使用操作系统的功能，完成数据读取写入等操作。**总而言之，API是一个功能接口，轻松实现和其他软件组件交互**  
...
## <font color = green>备注 </font>
  1. API (Application Programming Interface) 是可用于设计两个或多个软件解决方案之间通信的编程接口，是一个或多个程序或应用中组件之间的接口，通过接口可以交换数据。
		...
		API在现代软件开发中发挥着至关重要的作用，因为它们提供了许多优势：
...
鉴于现代软件体系结构中API的众多优势和日益增加的依赖性，API的理解及其正确实现对于开发人员和公司来说都是至关重要的。
...
面向协议的API（Protocol-oriented API）：独立于特定的操作系统或硬件<a id ="01-2"> [<font color = red>跳回</font>](#01-1)

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ5NzIwNzY1OCw5MTU1NjY2MDIsMTM3MD
