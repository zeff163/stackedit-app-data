...
一种通过Github1s，在目标url中，github后加上1s（适合代码阅读，不便于修改）：     ```https://github.com/... 改成 
	https://github1s.com/...```
	另一种通过Github.dev，可以直接在英文模式中按`.`这个键；或者将url中`.com`改成`.dev`	 
	 ```https://github.com/... 改成 https://github.dev/...```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgwNzMyNjM4LC04NDU1ODI2MiwtMTM2MT
M4MzExOCwxNTI0MDYxMTQwLC04NzI3OTA1NTQsLTE4ODk0NTUy
ODUsMTc4NjI3MjA3NCwtMTU4NzM4MzE1MCwtMTUzNTAyNjY1LD
EwODU3NjY3ODMsLTE0MTAxNTQ5NjcsLTI4MjI5ODMxNSwtMTI3
Mzc0NjYxOCwtMTM1MjE5NTk5OCwtMjE0MjM2NjQ2LC0zNjAwOD
E2NjcsLTEwMzc0MjkyODAsMTkzODU1ODQzNSwtNTYzNTkyNDI2
LC0xMTExMjgwNTUwXX0=
-->