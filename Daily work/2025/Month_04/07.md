...
根据DeepSeek分析推荐，综合易用性、功能全面性、兼容性、是否免费、社区生态、入门难度，综合选出了以下几款绘制流程图的工具。具体分析参考<a id="01-1">[<font color = red>**备注1**</font>](#01-2)。

Visio、PPT、Figma、ProcessOn、Draw.io、Mermaid，关于这几款工具的优劣，参考<a id="02-1">[<font color = red>**备注2**</font>](#02-2)，以及该链接 https://zhuanlan.zhihu.com/p/683582533  


除此之外，latex也可以用Tikz宏包来画流程图，不过latex使用起来太麻烦了，暂且不用。关于用latex实现流程图的例子，可以参考文章 [Tikz/PGF的学习笔记开端](https://mp.weixin.qq.com/s?__biz=MzU1OTE2MDI4OA==&mid=2247486696&idx=1&sn=ce923bfb0136819e68aca788f8e55d49&chksm=fc1ac267cb6d4b71520dc5e9981f82f77fafb9040801c0784de97f722cf345f7ac4524cd6d1e&scene=27)

<font color =red>综合以上考虑，决定采用 Draw.io + Mermaid 的方式。原因如下：</font>
+ Draw.io 免费，开源，可线上操作，与github同步保存
+ 操作简单，可视性强
+ 有良好生态，众多使用者开发插件
+ Draw.io 自身不支持嵌入Markdown，但可以转化为Mermaid插入Markdown中。而且Draw.io可以插入latex代码

关于两款常用工具 ProcessOn、Draw.io的比较，可以参考这个问题【
https://www.zhihu.com/answer/1072410826 
https://www.zhihu.com/answer/2480766440

> <font color = o> 其他内容：
> + <font color = o>一个可以在线编辑手绘风格流程图的浏览器插件 
	https://b23.tv/6fpV7tx
...
- [ ] **【手把手教你使用DeepSeek进行文献阅读】**
	https://www.bilibili.com/video/BV17zNUeuE2u/?share_source=copy_web
...
- [ ] **【挑战1分钟学会用Deepseek+Mermaid一键生成流程图-哔哩哔哩】**
	 https://b23.tv/BC6Xqcs

### Mermaid使用 
- [ ] https://blog.csdn.net/Subson/article/details/78054689
- [ ] https://blog.csdn.net/subson/article/details/75126945
...
## <font color = green>备注 </font>
  1. #### **1. 核心功能特点**  <a id ="01-2">[<font color = red>跳回</font>](#01-1)
		#### 📌 **易用性**
		...
		-   **插件生态**：支持第三方插件扩展功能（如 Draw.io 的插件库）。

2. ### 流程图工具对比分析  <a id ="0-2">[<font color = red>跳回</font>](#02-1)
	...
	- **优势**：完全免费，跨平台灵活。可以输入latex命令。
	- **劣势**：模板较少，自动布局弱。图标不支持中文搜索。
	- **适用场景**：日常使用与开源项目。

	#### Mermaid
	- **优势**：文本驱动，无缝集成 Markdown。
	- **劣势**：学习门槛高，样式局限。
	- **适用场景**：技术文档与开发者笔记。
...
```
十二经络路线，口诀快速记忆：
<font color =red>**大拇指**</font>通肺经，<font color =red>**食指**</font>通大肠经；
<font color =red>**里侧中指**</font>走心包，<font color =red>**外侧无名**</font>走三焦；
<font color =red>**小指外侧**</font>走小肠，<font color =red>**内侧**</font>与心相表里。
<font color =red>**胃经**</font>走腿外侧缘，对内<font color =red>**脾经**</font>运化关。
<font color =red>**胆经**</font>走在外中间，对内<font color =red>**肝经**</font>运循行线。
<font color =red>**膀胱**</font>背部走小指，<font color =red>**肾经**</font>足底起涌泉。


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQwNjQxODM5Niw3Nzg2ODYzOTksNDc2MD
Q1NTY1LDE3NTA3ODI1MjYsNzg0OTQxMzQyLC02ODM2MjkwMDYs
LTE2ODAxNTgxNzYsLTE1MzQ5MzE1MzAsOTI5NzYwODUzLDIxMz
YyMTA1NjQsMTgyOTM4NDcxMiwtMTc5MTE3MTI1OCwxMjc3MTQz
Nzg5LC0xMzI5MTI3Njc3LDEyMTcwOTQzMzQsMTkxOTY5NzY3NC
wyNjM1NjgzNDgsLTE2OTU0ODczNzAsODU3NjU1NTQyLDQ5OTE5
MjQ5M119
-->