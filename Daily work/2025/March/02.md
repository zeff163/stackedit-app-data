...
2. Markdown 支持几乎全部的的 html 标签。如果遇到一些难以用 markdown 标签实现的效果，又不想自定义 css 文件时，可以考虑用 html 标签来解决问题。标签包括：居中`<center> </center>`、换行`<br>`、斜体`<i> </i>`、强调`<em> </em>`、下标`<sub> </sub>`等。<br> <a id ="02-2">[<font color = red>跳回](#02-1)




<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM0MTUwMjg2OSwtMTM1MjE5NTk5OCwtMj
