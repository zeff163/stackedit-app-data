...
+ **地球的运动**
	 + <mark> 春分点的计算</mark>
		 ><font color =o>春分点的位置实际上是由地轴在黄道平面上投影的角度$\alpha$决定的，当日地连线平行于该投影方向是，则为**两至点**（冬至、夏至），若垂直于该方向，则为**两分点**（春分、秋分）<br/> <font color = red>实际上，两至点的连线和两分点的连线互相垂直，交点即为太阳。</font></font>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM4Njk3OTk2NiwxNjkyNzE0NjE3LC0zMz
