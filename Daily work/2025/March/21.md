...
+ **获取网页图片方式的汇总**  
	...
	4. <mark>通过浏览器`f12`开发者模式</mark>$\;$ 在开发者模式中可以找到图片的源文件，然后保存下载；对于代码嵌入的图片，可以使用DeepSeek提取图片的链接，然后
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAxMzcwNDcsMTkyMzIyMjQ3NywxMjM2OT
M2ODI2LDE5NzIzMDc3NTgsOTIzODcxMDQ0LDc4OTcyNDUzOSwt
MTA2MDY5NjY2MSwtMTA4MjQwMDM0Myw2NjA4MDI0ODcsLTMyMD
Q2Mjk4MiwtMTYzMDExOTQ1MF19
-->