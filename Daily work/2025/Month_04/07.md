...
+ mermaid
Mermaid‌ 是一个基于JavaScript的图表工具，它使用Markdown风格的语法来绘制各种图表。Mermaid允许用户通过编写特定的文本代码来生成流程图、时序图、甘特图等多种类型的图表，极大地简化了图表创建的过程‌
12。核心特性‌跨平台兼容性‌：Mermaid可以无缝嵌入GitHub、Notion、VS Code等开发协作工具，支持在Markdown和HTML中直接使用‌4。‌AI增强‌：结合DeepSeek等工具，可以通过自然语言生成图表代码，降低了使用门槛‌4。‌自定义样式‌：支持通过CSS调整节点颜色、字体等，使得图表更加个性化‌4。‌易于使用‌：Mermaid的语法简单直观，即使没有编程基础的用户也能快速上手‌3。
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNjE0Mzg5MjYsMTU0NTA3NzA3MiwtMz
MyMTg5NzM4LDE3MDM5ODc1NTksLTQ5MjgzNDYxNiwtMTY5NDk3
OTQ3MCwxMzA4MzI0NzQxLDEwNDUwNTMxNzcsLTE4NDQxMTkxND
IsLTMxNDA0NDMxMiwtMTI2MDYyNTczMiwxODgwNTM2MDM4LDQ5
OTkwMTI4OCwxMDU5MTk5NzUzLDEyMTg3NDM0MDMsLTIwMzczMz
UwMTEsMTA1NDI4MzQ2NSwtMjg3Njk3NTQzLDczNDE0NDUxLDE5
NjA3NTkyNDVdfQ==
-->