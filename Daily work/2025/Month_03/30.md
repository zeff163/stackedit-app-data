...
+ **手机和平板**  
	...
	+ 文字类
		 开启蓝牙直接显示手机浮窗、QQ、微信、利用可乐记生成txt文件传输
+ **手机和电脑**  
	+ 文件类 
		1. 本地端：ES文件浏览器（只能手机传向电脑）、数据线、蓝牙
		3. 第三方中转端：mega 、overleaf 、微信
	+ 文字类
...
+ **电脑和平板**  
	+ 文件类 
		...
		3. 第三方中转端：mega 、overleaf 、微信、GitHub、123云盘、Telegram
	+ 文字类
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMDU2NDA3NzksLTE1ODMxOTQxMzIsLT
E3MTg5NDI0NDddfQ==
-->