...
**Github仓库中单个文件夹下载工具download-directory**
https://download-directory.github.io/

<font color = red>**说明：实际上Github官方自己就有下载文件夹的工具**</font>
在当前仓库，按`.`打开dev，然后可以在右端看到该仓库的文件信息，选中要下载的文件夹，【右键】--- 【下载】即可。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzQ5MzI3ODE4LDUyNDkyNzkxOV19
-->