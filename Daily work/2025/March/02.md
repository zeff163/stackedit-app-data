...
+ **HTML格式转换为pdf格式的方式**
	...
	3. 保存为PDF：在打印对话框中选择“保存为PDF”作为打印目标，并设置必要的选项，如页面范围、纸张大小等3。
完成转换：点击“打印”或“保存”按钮，浏览器将生成并保存PDF文件3。
...
- 3.01
	...
	需要自行配置相应的模板格式，暂时不会。另一种解决方案，先导出为html文档，然后转为pdf。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODAyMTg2MjAsLTE1MzUwMjY2NSwxMD
g1NzY2NzgzLC0xNDEwMTU0OTY3LC0yODIyOTgzMTUsLTEyNzM3
NDY2MTgsLTEzNTIxOTU5OTgsLTIxNDIzNjY0NiwtMzYwMDgxNj
Y3LC0xMDM3NDI5MjgwLDE5Mzg1NTg0MzUsLTU2MzU5MjQyNiwt
MTExMTI4MDU1MCwtMTE3MDg5NTE1LC0yMDkyNDMwOTc4LC0yMD
