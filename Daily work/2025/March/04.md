...
+ **一些具体情景案例对话DeepSeek的技巧**  
	个人觉得，向DS询问的一个问题，实际上应该向他展示自己思考这个问题的一个框架，然后让DS进行细节补全和效果实现。一般我们提问的问题可以分为两类：1.已经有答案，可以在网上搜到  2.没有答案，需要重新分析
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY5OTc3MTc5Niw5MzQ1NDExMDYsNjAyNz
